        ...
        $this
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ->when(! $this->getModel()->getKey(), function (TextFieldOption $option) {
                        do {
                            $uniqueId = rand(000000, 999999);
                        } while (Account::query()->where('unique_id', $uniqueId)->exists());

                        $option->value((string) $uniqueId);
                    })
